  ...
  <body role="document">
	...
	<div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              <li class="active">
                      <a href="viewEvento.php"> Evento </a>
              </li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    ...
    <div class="container theme-showcase" role="main">
        ...
        <form class="form" method="post" action="viewEventoAlterar.php">
            ...
            <div class='row'>
                ...
                <div class="col-sm-6">
                    <label>Data: </label>
                    <input type="text" name="data" value="<?php echo $_GET['data']; ?>" class="form-control">
                </div>
            </div>
            ...
            <div class='row'>
                <div class="col-sm-6">
                    ...
                    <input type="text" name="responsavel" value="<?php echo $_GET['responsavel']; ?>" class="form-control">
                </div>
                <div class="col-sm-6">
                    <label>Carga Horária: </label>
                    <input type="number" name="carga_horaria" value="<?php echo $_GET['carga_horaria']; ?>" class="form-control">
                </div>
            </div>
            <br>
