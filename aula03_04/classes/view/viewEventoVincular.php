...
<html lang="en">
  ...
  <body role="document">
    ...
    <form class="form" method="post" action="viewEventoVincular.php?id=<?=$_GET['id']?>&nome=<?=$_GET['nome']?>">
        <input TYPE="hidden" NAME="form_submit" VALUE="OK">

        <button type="submit" name="acao" value="concluir/<?=$_GET['id']?>" class="btn btn-success btn-block">
        ...
        <table class='table table-striped'>
            ...
            <tbody>
                <?php
                    controleEvento::loadTabelaVincularAlunos($_GET['id']);
                ?>
            </tbody>
        </table>
